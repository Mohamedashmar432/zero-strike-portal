// Official brand marks (simple-icons, CC0), inlined as plain SVG so the app doesn't take on a
// whole icon-library dependency just for four static logos.
function IconBase({ path, className }: { path: string; className?: string }) {
  return (
