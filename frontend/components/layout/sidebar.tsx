...
export function Sidebar() {
  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col overflow-y-auto border-r border-sidebar-border bg-sidebar py-6 text-sidebar-foreground shadow-2xl shadow-black/40 md:flex">
