...
const MAP: Record<FixReviewState, { label: string; className: string }> = {
  ...
  validated: { label: "Validated", className: "bg-status-success/15 text-status-success" },
  pr_open: { label: "PR opened", className: "bg-status-success/15 text-status-success" },
